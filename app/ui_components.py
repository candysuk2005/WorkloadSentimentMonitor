...
def display_sidebar_info(report_data):
    ...
    st.sidebar.info(
        "A Proof of Concept for using sentiment analysis to help identify potential employee burnout."
    )
    ...
    st.sidebar.selectbox(
        ...
        options=["Vader Model", "Classification Model"],
        key='selected_model',
    ...
    if report_data and st.session_state.selected_model in report_data:
        ...
        matrix_df = pd.DataFrame(
            ...
            columns=model_report['confusion_matrix_labels'],
    ...
    # --- MODIFIED: Changed header and removed recommendation ---
